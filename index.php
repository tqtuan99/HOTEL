         ...
         <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
               ...
               <div class="flex-1 hidden sm:block sm:ml-6">
                  <div class="flex justify-start space-x-4 text-center">
                     <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                     <a href="#" class="text-white hover:text-pink-300 hover:bg-gray-600 px-3 py-2 rounded-md ">Dashboard</a>

                     <a href="#" class="text-white hover:text-pink-300 hover:bg-gray-600 px-3 py-2 rounded-md ">Team</a>

                     <a href="#" class="text-white hover:text-pink-300 hover:bg-gray-600 px-3 py-2 rounded-md ">Projects</a>

                     <a href="#" class="text-white hover:text-pink-300 hover:bg-gray-600 px-3 py-2 rounded-md ">Calendar</a>
                  </div>
               </div>
            </div>
         ...
         <div class="flex flex-wrap text-center text-white">
            ...
            <div class="w-full md:w-1/3 p-5 border-r-2 border-opacity-30">
               ...
               <p class="p-3 text-gray-200">
                  ...
                  Viet Nam <br>
                  <strong>Phone:</strong> <a class="text-blue-200 hover:underline hover:text-blue-400"
                     href="tel:+84 385 555 555">+84 385 555 555</a> <br>
                  <strong>Email:</strong> <a class="text-blue-200 hover:underline hover:text-blue-400"
                     href="mailto:infohotel@gmail.com">infohotel@gmail.com</a>
               </p>

               <div class="relative w-20 h-20 mx-auto my-12 bg-blue-300 rotate-45">
                  <div
                     class="flex justify-center items-center absolute left-0 top-0 w-10 h-10 hover: hover:-mt-1 bg-blue-800 cursor-pointer">
            ...
            <div class="w-full md:w-1/3 p-5">
               ...
               <form class="p-3 w-4/5 mx-auto mt-2 px-6 pt-6 pb-4 rounded">
                  <div class="flex items-center mb-4">
                     <input class="w-full h-10 p-2 border-blue-200 bg-white text-gray-800 rounded-xl" type="email"
                        placeholder="example@gmail.com" required>
                  </div>
                  <div class="flex items-center mb-4">
                     <input class="w-full h-10 p-2 border-blue-200 bg-white text-gray-800 rounded-xl" type="password"
                        placeholder="password" required>
                  </div>
                  <div class="mb-6">
                     <textarea class="w-full h-24 px-2 pt-2 border-blue-200 bg-white text-gray-800 rounded-xl"
                        placeholder="Message" required></textarea>
                  </div>
                  <div class="flex justify-between items-center bg-btn rounded-tl-3xl rounded-br-3xl">
                     <button
                        class="animate-pulse bg-btn w-full py-2 px-4 text-white font-bold rounded-tl-3xl rounded-br-3xl"
