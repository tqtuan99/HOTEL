   ...
   <div class="m-auto bg-gray-100 mt-7">
      <div class="flex flex-col max-w-screen-lg m-auto bg-white">
         <div class="flex flex-col m-10 p-4 gap-y-4 bg-white shadow-2xl rounded-b-full">
            <div class="">
               <h3 class="text-3xl font-bold text-blue-600">KLT HOTEL</h3>
            ...
            <form class="flex justify-end">
               <div class="flex flex-col">
                  <p class="font-bold">Giá phòng mỗi đêm từ</p>
         ...
         <form method="GET" action="#" class="flex flex-col m-10 p-4 gap-y-4 bg-white shadow-2xl rounded-t-full">
            ...
            <div class="flex flex-col">
               <div class="flex justify-between items-center">
                  ...
                  <button name="comment" class="p-2 rounded-md border-2 border-gray-800 bg-gray-400">Comment</button>
               </div>
               <div class="w-full px-4">
                     ...
                     <label class="notification" style="color: red;" for="">Vui lòng chọn số sao</label>
               </div>
               <div class="flex px-10 py-5 gap-x-3 mb-5">
                  <div class="flex-1 border border-yellow-400 rounded-xl">
                     <textarea required name="content" id="content" placeholder="Add to the discussion" required class="bg-gray-100 rounded-xl w-full h-full p-3"></textarea>
                  </div>
               </div>
