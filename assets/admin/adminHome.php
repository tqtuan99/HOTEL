...
<body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
   ...
   <div class="flex flex-col lg:flex-row mx-4">
      ...
      <div class="bg-gray-800 shadow-xl h-16 fixed bottom-0 mt-12 lg:h-screen z-10 w-full lg:w-60">
         <div class="lg:mt-12 lg:w-60 lg:fixed lg:left-0 lg:top-0 content-center lg:content-start text-left justify-between">
            <ul class="list-reset flex flex-row lg:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
               <li class="mr-3 flex-1">
                  <a href="#" class="js-show-data block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                     <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Account
                        Management</span>
                  </a>
               </li>
               <li class="mr-3 flex-1">
                  <a href="#" class="js-show-data block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                     <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Employ
                        Management</span>
                  </a>
               </li>
               <li class="mr-3 flex-1">
                  <a href="#" class="js-show-data block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-purple-500">
                     <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Room
                        Management</span>
                  </a>
               </li>
               <li class="mr-3 flex-1">
                  <a href="#" class="js-show-data block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-blue-600">
                     <i class="fas fa-chart-area pr-0 md:pr-3 text-blue-600"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">Statistical</span>
                  </a>
               </li>
               <li class="mr-3 flex-1">
                  <a href="#" class="js-show-data block py-1 md:py-3 pl-0 md:pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-red-500">
                     <i class="fa fa-wallet pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">Log
                        Out</span>
                  </a>
               </li>
            </ul>
      ...
      <!-- *MAIN -->
      <div id="main-contend" class="lg:ml-64 px-4">
         ...
         <div class="js-show-employ employ-management bg-gray-100 mt-12 md:mt-2">
            ...
            <button class="open-modal-employ block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="authentication-modal">
               Add Employ
            </button>
